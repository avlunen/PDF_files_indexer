...
def init_index_list(ind_list):
    with io.open('index.txt', mode='r', encoding='utf-8') as tsv:
...
def main():
    ...
    for x in range(number_of_pages):
        ...
        #page_content = re.sub('.,;:()’“”!?/', '', page.extractText())
        #page_content = ' '.join((re.sub('-\.,;:\(\)’“”!\?/\n', '', pdf2[page_number])).split())
